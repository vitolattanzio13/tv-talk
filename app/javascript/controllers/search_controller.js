...
export default class extends Controller {
  ...
  #insertResult = (result) =>{
    if (result.type === "user") {
      ...
      this.linksTarget.insertAdjacentHTML("beforeend", `<a class="search-result-link form-font-size" href="/movies/${result.url}/chatrooms/${result.chat}">${result.title} discussion</a>`)
    }
  };
}
